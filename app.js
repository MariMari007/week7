...
const villainSpan = document.querySelector('#villain');  // Corrected the selector for villain
...
const weapon = ['plastic fork', 'banana peel', 'flip-flop', 'magic wand', 'wooken sword', 'rotten egg'];
...
launcherBtn.addEventListener('click', () => {
    ...
    villainSpan.innerHTML = `Villain ${randomVillain} is armed with a/an ${randomVillainWeapon}.`;  // Corrected "Hero" to "Villain"

    const heroStrike = randomHero.length + randomHeroWeapon.length;
    const villainStrike = randomVillain.length + randomVillainWeapon.length;  // Corrected "villsinStrike" to "villainStrike"
